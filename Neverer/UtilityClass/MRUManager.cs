...
namespace Community.Core
{
    ...
    public class MRUManager : Component
    {
        ...
        {
            get { return clearListMenuItemText; }
        ...
        {
            get { return (exts == null) ? string.Empty : string.Join("|", exts); }
        ...
        public void AddRecentFile(string fileNameWithFullPath)
        {
            if (string.IsNullOrWhiteSpace(fileNameWithFullPath) || !File.Exists(fileNameWithFullPath))
                throw new System.IO.FileNotFoundException("Unable to add a file that doesn't exist.", fileNameWithFullPath);
            ...
            private StringCollection SettingsValue
            {
                get
                {
                    ...
                    else
                    {
                        try
                        {
                            return settings[propName] as StringCollection;
                        }
                        catch (Exception ex)
                        {
                    ...
                    /*return settings != null ? settings[propName] as StringCollection : new StringCollection(); */
                }
...
namespace Community.Windows.Forms
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MenuStripMRUManager"/> class.
        /// </summary>
        ...
        public MenuStripMRUManager(string extensions, ToolStripMenuItem parentMenuItem, Action<string> onRecentFileClick, Action<StringCollection> onClearRecentFilesClick = null, IFileListStorage storageHandler = null)
            : base(storageHandler == null ? new AppSettingsFileListStorage() : storageHandler, new MenuStripMenuBuilder())
        {
        ...
        {
            get { return ((MenuStripMenuBuilder)MenuBuilderHandler).RecentFileMenuItem; }
        ...
        private class MenuStripMenuBuilder : IMenuBuilder
        {
            ...
            public void RebuildMenus(IEnumerable<string> files, Action<string> fileMenuItemClick, string clearListMenuItemText = null, Action clearListMenuItemClick = null)
            {
                if (RecentFileMenuItem != null)
                {
                    ...
                    files.ToList().ForEach(f => RecentFileMenuItem.DropDownItems.Add(new ToolStripMenuItem(CompactPath(f, RecentFileMenuItem.Font, RecentFileMenuItem.Width), null, OnFileMenuItemClick) { Tag = f }));
            ...
            public static string CompactPath(string stringToCompact, System.Drawing.Font font, int maxWidthInPts)
            {
                string compactedString = string.Copy(stringToCompact);
                TextRenderer.MeasureText(compactedString, font, new System.Drawing.Size(maxWidthInPts, 0), TextFormatFlags.PathEllipsis | TextFormatFlags.ModifyString);
